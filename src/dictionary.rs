...
impl DictionaryGenerator {
    ...
    pub fn builtin_secrets() -> Vec<String> {
        let static_words: &[&str] = &[
            ...
            "key", "jwt", "token", "auth", "secure", "private",
            "mysecret", "mypassword", "myjwt", "jwtkey", "jwttoken",
            "jwtpassword", "jwtsecret", "jwtauth", "jwtprivate",
            "secret123", "password123", "admin123", "test123",
            "12345678", "123456789", "1234567890", "00000000",
            "changeme", "changeit", "change_me", "change-me",
            "default", "defaults", "placeholder",
            // 常见框架/项目名
            "spring", "springboot", "laravel", "django", "express",
            "nodejs", "node", "flask", "rails", "symfony",
            "app", "application", "backend", "frontend", "server",
            "api", "apikey", "api_key", "api-key", "apitoken",
            // 空值/数字序列
            "", " ", "0", "1", "000", "111", "999",
